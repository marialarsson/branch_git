...
def main():
    ...
    train_d = BranchDataset(args.dataset, data_range=(1,10))
    test_d = BranchDataset(args.dataset, data_range=(10,14))
    ...
    # print('load models')
    # chainer.serializers.load_npz('/home/hyoshida/git/pix2pix_learning/results/120269/enc_iter_10000.npz', enc)
    # chainer.serializers.load_npz('/home/hyoshida/git/pix2pix_learning/results/120269/dec_iter_10000.npz', dec)
    # chainer.serializers.load_npz('/home/hyoshida/git/pix2pix_learning/results/120269/dis_iter_10000.npz', dis)

    # print out_image(updater, enc, dec, 5, 5, args.seed, args.out)
